...
↪️ Reply with your new minimum $ value for positions to be displayed. <i>Example: 0.01</i>
`;
...
↪️🔻 Reply with your new Auto Sell Amount in %. Example: 50
`;
...
const replyOrderMsg = () => `
↪️ Reply with your new order setting. Example: -25 50
`;
...
❌🔢 Invalid number entered. Please try again. <i>Example: 0.5</i>
`;

const numberLimitMsg = () => `
❌🔢 Number can not be under 0 or over 100. Please try again. <i>Example: 50</i>
`;
